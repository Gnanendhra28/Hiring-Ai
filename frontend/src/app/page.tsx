      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <div className="p-12 rounded-3xl glass-panel border border-slate-800 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/login" className="w-full sm:w-auto px-8 py-4 text-base font-semibold rounded-xl glass-panel-hover text-slate-200 border border-slate-700">Log in</Link>
            <Link href="/signup" className="w-full sm:w-auto px-8 py-4 text-base font-bold rounded-xl btn-shimmer text-white shadow-xl shadow-sky-500/25">Sign up →</Link>
          </div>
        </div>
      </section>
