      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative">
        <div className="glass-panel p-8 md:p-10 rounded-3xl max-w-md w-full border border-slate-800 shadow-2xl relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="work-email-input" className="block text-xs font-mono uppercase text-slate-400 mb-1.5">
                Work Email
              </label>
              <input
                id="work-email-input"
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="employee-password-input" className="text-xs font-mono uppercase text-slate-400">
                  Password
                </label>
                <button
                  type="button"
