      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900/60 border-r border-slate-800 p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-mono">
            ...
            <span>EMPLOYEE &amp; RECRUITER PORTAL</span>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-lg my-auto space-y-6">
          <h1 className="text-4xl xl:text-5xl font-black text-white tracking-tight leading-tight">
            Build your team. <br />
            <span className="text-gradient-cyan">Hire with evidence.</span>
          </h1>
          ...
          <div className="p-4 rounded-2xl glass-panel border border-emerald-500/30 flex items-center space-x-3 bg-emerald-950/20">
            ...
            <div>
              ...
              <div className="text-xs text-slate-300">Recruiters hold 100% authority for all candidate advancement &amp; hiring decisions.</div>
            </div>
          </div>
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center space-x-3 text-xs font-medium text-slate-300">
              ...
              <span>4-factor deterministic match engine with zero autonomous decision paths</span>
            </div>
            <div className="flex items-center space-x-3 text-xs font-medium text-slate-300">
              <span className="w-1.5 h-1.5 rounded-full bg-sky-400" />
              <span>Requisition intelligence parsing &amp; skill normalization</span>
            </div>
            <div className="flex items-center space-x-3 text-xs font-medium text-slate-300">
              <span className="w-1.5 h-1.5 rounded-full bg-sky-400" />
              <span>Enterprise tenant isolation with PostgreSQL RLS &amp; audit streaming</span>
            </div>
          </div>
        </div>
            ...
            <>
              ...
              <div className="mb-6">
                <button
                  ...
                  disabled={isSubmitting}
                  className="w-full py-3 px-4 rounded-xl bg-slate-900/80 hover:bg-slate-800 border border-slate-700 hover:border-slate-600 text-white text-xs font-semibold flex items-center justify-center space-x-2.5 transition-all shadow-sm group"
                >
          ...
          {step === "RESET_PASSWORD" && (
            <>
              <div className="mb-6">
                ...
                <p className="text-xs text-slate-400 mt-1">
                  A 6-digit OTP code has been sent to <span className="text-sky-300 font-mono font-bold">{resetEmail}</span>. Please check your email inbox.
                </p>
              </div>
            ...
            <div className="text-center py-4 space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 mt-2 leading-relaxed">
                  Your employee account password for <span className="text-sky-300 font-mono font-bold">{resetEmail}</span> has been updated successfully in the portal database.
                </p>
              </div>
