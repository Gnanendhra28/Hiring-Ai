            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <button
                  ...
                  className="py-2.5 px-4 rounded-xl bg-slate-900/90 hover:bg-slate-800 border border-slate-800 text-slate-200 hover:text-white text-xs font-semibold flex items-center justify-center space-x-2 transition-all cursor-pointer"
                >
                  <span>Google</span>
                </button>
                ...
                >
                  <span>LinkedIn</span>
                  <span className="text-[9px] font-mono px-1.5 py-0.5 rounded bg-slate-800 text-slate-500">Soon</span>
                </button>
              </div>
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Enter your registered account email address to receive password recovery instructions.
                </p>
              </div>
            ...
            <div className="text-center py-4 space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300 mt-2 leading-relaxed">
                  Your account password for <span className="text-sky-300 font-mono font-bold">{resetEmail}</span> has been updated successfully in the portal database.
                </p>
              </div>
